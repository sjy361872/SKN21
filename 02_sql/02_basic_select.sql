...
select	emp_id, emp_name, salary as 봉급
from	emp
where	salary > 10000;
...
where emp_name like '%&%%' escape '&'; -- escape '특수문자' 특수문자뒤에 %나 _ 는 조회할 값임을 표히.(like의 패턴문자가 아니라)
...
and hire_date >= '2005-01-01'; -- year(hire_date) >= 2005
